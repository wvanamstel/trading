...
class Position(object):
    def __init__(self, side, market, units, exposure, avg_price, cur_price):
        ...
        self.exposure = exposure  # money exposure in base currency
        self.avg_price = avg_price  # average price of position
        self.cur_price = cur_price  # current price of currency pair
